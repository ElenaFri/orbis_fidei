...
- [x] Helmet actif + CSP explicite (`default-src`, `object-src`, `frame-ancestors`, `connect-src`)
...
- [x] Audit `pnpm audit --audit-level=high` en CI
- [x] Journalisation persistante des actions sensibles (`EditorialAction`)
